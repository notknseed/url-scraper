@echo off
echo ================================================
echo     Website URL Scraper - Smart Launcher
echo ================================================
echo.
...
powershell -Command "try { Invoke-WebRequest -Uri 'https://www.python.org/ftp/python/3.11.9/python-3.11.9-amd64.exe' -OutFile 'python_installer.exe' -UseBasicParsing } catch { Write-Host 'Download failed'; exit 1 }"
...
echo 📝 Or double-click this file again to run setup check
goto :normal_end
